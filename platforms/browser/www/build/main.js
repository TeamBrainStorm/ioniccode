...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_parse__ = __webpack_require__(35);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_user_user__ = __webpack_require__(20);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var ChangePasswordPage = /** @class */ (function () {
    ...
    ChangePasswordPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'page-change-password',template:/*ion-inline-start:"/Users/rapsong11/Desktop/Groove+web(2018-6-24)/DistrictGroove/src/pages/change-password/change-password.html"*/'<!--\n  Generated template for the ChangePasswordPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n\n  <ion-navbar>\n    <ion-title>ChangePassword</ion-title>\n  </ion-navbar>\n\n</ion-header>\n\n\n<ion-content padding>\n  <ion-input class="round-white-back" placeholder="Old Password" type="password" [(ngModel)]="oldPassword"></ion-input>\n  <ion-input class="round-white-back"placeholder="New Password" type="password" [(ngModel)]="newPassword"></ion-input>\n  <ion-input class="round-white-back"placeholder="Confirm Password" type="password" [(ngModel)]="confirmPassword"></ion-input>\n  <div style="display: flex">\n    <button ion-button (click)="cancel()" style="flex: 1">Cancel</button>\n    <button ion-button (click)="update()" style="flex: 1">Update</button>\n  </div>\n</ion-content>\n'/*ion-inline-end:"/Users/rapsong11/Desktop/Groove+web(2018-6-24)/DistrictGroove/src/pages/change-password/change-password.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["m" /* NavParams */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["o" /* ViewController */], __WEBPACK_IMPORTED_MODULE_2__providers_user_user__["a" /* UserProvider */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["d" /* Events */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["b" /* AlertController */]])
    ], ChangePasswordPage);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_message_message__ = __webpack_require__(291);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__list_list__ = __webpack_require__(52);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_chat_chat__ = __webpack_require__(104);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__providers_user_user__ = __webpack_require__(20);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var ChatPage = /** @class */ (function () {
    ...
    ChatPage.prototype.sendMessage = function (newMessage) {
        ...
        this.messageProvider.sendMessage(newMessage, this.thread.id, this.userId).then(function (result) {
            _this.messages.push({
    ...
    ChatPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'page-chat',template:/*ion-inline-start:"/Users/rapsong11/Desktop/Groove+web(2018-6-24)/DistrictGroove/src/pages/chat/chat.html"*/'<!--\n  Generated template for the ChatPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n\n  <ion-navbar>\n    <ion-title>{{thread.attributes.artistInfo.firstName}} {{thread.attributes.artistInfo.lastName}}</ion-title>\n\n  </ion-navbar>\n\n</ion-header>\n\n\n<ion-content>\n  <ion-list no-lines>\n    <message-box\n      *ngFor="let message of messages"\n      [message]="message"\n      [photo]="thread.attributes.artistInfo.avatar"\n      [isFromSender]="(message.userId == userId)">\n    </message-box>\n  </ion-list>\n</ion-content>\n<ion-footer>\n  <ion-input placeholder="Write your message ..." [(ngModel)]="newMessage" style="color:#262626;padding:5px;padding-right:20%;height: 50px"></ion-input>\n  <button ion-button [disabled]=" ! newMessage" (click)="sendMessage(newMessage); newMessage = \'\' " style="position:absolute; right: 3%; padding:8px;top: 13%;border-radius: 50%;bottom: 15%; margin: 0; width: 39px; height: 39px;">\n    <ion-icon name="md-send"></ion-icon>\n  </button>\n</ion-footer>\n'/*ion-inline-end:"/Users/rapsong11/Desktop/Groove+web(2018-6-24)/DistrictGroove/src/pages/chat/chat.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["m" /* NavParams */], __WEBPACK_IMPORTED_MODULE_2__providers_message_message__["a" /* MessageProvider */], __WEBPACK_IMPORTED_MODULE_4__providers_chat_chat__["a" /* ChatProvider */], __WEBPACK_IMPORTED_MODULE_5__providers_user_user__["a" /* UserProvider */]])
    ], ChatPage);
    return ChatPage;
}());
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_artist_artist__ = __webpack_require__(86);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__book_book__ = __webpack_require__(205);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_chat_chat__ = __webpack_require__(104);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__chat_chat__ = __webpack_require__(115);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__providers_user_user__ = __webpack_require__(20);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__login_login__ = __webpack_require__(119);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__register_register__ = __webpack_require__(87);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__list_list__ = __webpack_require__(52);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__ionic_native_themeable_browser__ = __webpack_require__(182);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__inbox_inbox__ = __webpack_require__(60);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var ArtistPage = /** @class */ (function () {
        ...
        this.userProvider.getCurrentUser()
            ...
            if (userRole === 'Customer') {
                ...
                _this.chatProvider.isThreadExist(_this.artist.id).then(function (results) {
                    if (results.length == 0) {
                        _this.chatProvider.createNewThread(_this.artist, currentUser).then(function (result) {
    ...
    ArtistPage.prototype.showArtistInfo = function () {
        var alert = this.alertCtrl.create({
            title: 'Artist',
            subTitle: this.artist.attributes.firstName + " is still working on his service information.",
            buttons: ['Dismiss']
        });
        alert.present();
    };
    ArtistPage.prototype.book = function () {
        var _this = this;
        if (this.userProvider.hasLoggedIn()) {
            this.userProvider.getCurrentUser().then(function (user) {
                var userRole = user.className;
                if (userRole === 'Customer') {
    ...
    ArtistPage.prototype.openArtist = function () {
...
var LoginPage = /** @class */ (function () {
    ...
    LoginPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'page-login',template:/*ion-inline-start:"/Users/rapsong11/Desktop/Groove+web(2018-6-24)/DistrictGroove/src/pages/login/login.html"*/'<!--\n  Generated template for the LoginPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n\n  <ion-navbar>\n    <ion-title>Login</ion-title>\n  </ion-navbar>\n\n</ion-header>\n\n<ion-content padding style="background-color: black">\n  <div style="text-align: center;">\n    <img src="assets/imgs/stroke.png" style="width: 60%;">\n  </div>\n  <ion-input class="round-white-back" placeholder="Email" type="email" [(ngModel)]="loginData.userName"></ion-input>\n  <ion-input class="round-white-back"placeholder="Password" type="password" [(ngModel)]="loginData.password"></ion-input>\n  <button ion-button class="round-white-back" (click)="doLogin()">Login</button>\n    <div *ngIf="isLoginLoading">\n      <ion-spinner icon="spiral"></ion-spinner>\n        <span>Logging in...</span>\n    </div>\n    <div style="text-align: center;" *ngIf="!isLoginLoading">\n      <ion-label style="color: white" (click)="forgotPassword()"><b>Forgot your password?</b></ion-label>\n      <ion-label style="color: white" (click)="showRegisterForm()"><b>Register Here</b></ion-label>\n    </div>\n    \n</ion-content>\n'/*ion-inline-end:"/Users/rapsong11/Desktop/Groove+web(2018-6-24)/DistrictGroove/src/pages/login/login.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["m" /* NavParams */], __WEBPACK_IMPORTED_MODULE_2__providers_user_user__["a" /* UserProvider */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["d" /* Events */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["b" /* AlertController */]])
    ], LoginPage);
    return LoginPage;
}());
...
var UserProvider = /** @class */ (function () {
    ...
    UserProvider.prototype.registerPerformer = function (register) {
        ...
        var point = new __WEBPACK_IMPORTED_MODULE_2_parse__["Parse"].GeoPoint({ latitude: register.latitude, longitude: register.longitude });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__ionic_native_camera__ = __webpack_require__(147);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_user_user__ = __webpack_require__(20);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__change_password_change_password__ = __webpack_require__(114);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__inbox_inbox__ = __webpack_require__(60);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var AccountPage = /** @class */ (function () {
    ...
    AccountPage.prototype.takePicture = function () {
        var _this = this;
        this.camera.getPicture(this.galleryOption).then(function (imagePath) {
            return imagePath;
    ...
    AccountPage.prototype.takePicturefromCamera = function () {
        var _this = this;
        this.camera.getPicture(this.cameraOption).then(function (imagePath) {
            return imagePath;
        }).then(function (imageBlob) {
            return _this.uploadPhoto(imageBlob);
        });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_book_book__ = __webpack_require__(106);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_user_user__ = __webpack_require__(20);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__inbox_inbox__ = __webpack_require__(60);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var BookPage = /** @class */ (function () {
    ...
    BookPage.prototype.book = function (datetimeValue) {
        var _this = this;
        if (this.profile.contactNumber == null || this.profile.contactNumber == '') {
            var alert_1 = this.alertCtrl.create({
                title: 'Warning!',
        ...
        this.bookProvider.book(bookInfo, this.profile, new Date(this.datetimeValue)).then(function (result) {
            console.log(result);
            _this.navCtrl.pop();
            _this.userProvider.getCurrentUser().then(function (user) {
                _this.navCtrl.pop();
            })
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__agm_core__ = __webpack_require__(107);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var PerformerRegisterPage = /** @class */ (function () {
            ...
            _this.getAddress(_this.coordinate).then(function (address) {
                ...
                if (_this.register.password == _this.register.confirmPassword) {
                    if (_this.register.password == "") {
                        ...
                        _this.userProvider.registerPerformer(_this.register).then((function (result) {
                            _this.navCtrl.pop();
                        }));
                    }
                }
            ...
            geocoder.geocode({ 'location': latlng }, function (results, status) {
                if (status == google.maps.GeocoderStatus.OK) {
                    ...
                    address_components.forEach(function (address) {
                        if (address.types[0] == 'administrative_area_level_1' && fullAddress.State != address.short_name) {
                            fullAddress.State = address.short_name;
                        }
                        if (address.types[0] == 'locality' && fullAddress.City != address.short_name) {
                    ...
                    var alert_4 = _this.alertCtrl.create({
                        title: 'Error',
                        subTitle: 'Geocode Error Geocode was not successful for the following reason: ' + status,
                        buttons: ['Dismiss']
                    });
                    alert_4.present();
                }
    ...
    PerformerRegisterPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'page-performer-register',template:/*ion-inline-start:"/Users/rapsong11/Desktop/Groove+web(2018-6-24)/DistrictGroove/src/pages/performer-register/performer-register.html"*/'<!--\n  Generated template for the RegisterPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n\n  <ion-navbar>\n    <ion-title>Register</ion-title>\n  </ion-navbar>\n\n</ion-header>\n\n<ion-content padding style="background-color: black">\n  <div style="text-align: center;">\n    <h1 style="color: rgb(255, 255, 255); font-size: 30px;">Create your <b>Preformer Account</b> for <b>FREE.</b></h1>\n    <h1 style="color: rgb(255, 255, 255); font-size: 16px;">No credit card required.</h1>\n  </div>\n  <ion-input class="round-white-back" placeholder="Stage Name" type="text" style="height: 40px !important;" [(ngModel)]="register.stageName" required></ion-input>\n  <ion-input class="round-white-back" placeholder="First Name" type="text" style="height: 40px !important;" [(ngModel)]="register.firstName" required></ion-input>\n  <ion-input class="round-white-back" placeholder="Last Name" type="text" style="height: 40px !important;" [(ngModel)]="register.lastName" required></ion-input>\n  <ion-input class="round-white-back" placeholder="Email" type="email" style="height: 40px !important;" [(ngModel)]="register.email" required></ion-input>\n  <ion-input class="round-white-back" placeholder="Mobile Number" type="number" style="height: 40px !important;" [(ngModel)]="register.contactNumber" required></ion-input>\n  <ion-input class="round-white-back" placeholder="Password" type="password" style="height: 40px !important;" [(ngModel)]="register.password" required></ion-input>\n  <ion-input class="round-white-back" placeholder="Confirm Password" type="password" style="height: 40px !important;" [(ngModel)]="register.confirmPassword" required></ion-input>\n  <ion-item class="round-white-back" style="padding-left: 8px;">\n    <ion-label>Service Type</ion-label>\n    <ion-select [(ngModel)]="register.serviceType">\n      <ion-option value="DJ">DJ</ion-option>\n      <ion-option value="Artist">Artist</ion-option>\n      <ion-option value="Band">Band</ion-option>\n    </ion-select>\n  </ion-item>\n  <div>\n    <a href="#" onclick="window.open(\'\', \'_system\', \'location=yes\'); return false;" style="font-size:12px;">By creating an account, I agree to DistrictGroove\'s <b>Terms of Service</b> and <b>Privacy Policy</b></a>\n  </div>\n  <button ion-button class="round-white-back" (click)="doRegister()">Register Now!</button>\n\n</ion-content>\n'/*ion-inline-end:"/Users/rapsong11/Desktop/Groove+web(2018-6-24)/DistrictGroove/src/pages/performer-register/performer-register.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["m" /* NavParams */], __WEBPACK_IMPORTED_MODULE_2__providers_user_user__["a" /* UserProvider */], __WEBPACK_IMPORTED_MODULE_3__ionic_native_geolocation__["a" /* Geolocation */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["d" /* Events */], __WEBPACK_IMPORTED_MODULE_4__agm_core__["b" /* MapsAPILoader */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["b" /* AlertController */]])
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_book_book__ = __webpack_require__(106);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__list_list__ = __webpack_require__(52);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__review_review__ = __webpack_require__(208);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__inbox_inbox__ = __webpack_require__(60);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
...
var AppointmentsPage = /** @class */ (function () {
    ...
    AppointmentsPage.prototype.getBookings = function () {
        ...
        if (this.userRole === 'Customer') {
            this.bookProvider.getBookingsById(this.customerProfile.id).then(function (results) {
                _this.bookings = results;
                _this.totalBookings = results;
            });
        }
        else if (this.userRole === 'Artist') {
            this.bookProvider.getBookingsByPerformerId(this.customerProfile.id).then(function (results) {
                _this.bookings = results;
                _this.totalBookings = results;
            });
        }
    ...
    AppointmentsPage.prototype.filterBooking = function (booking) {
        var response;
        if (!this.statusButton.pending && this.statusButton.accepted && this.statusButton.completed) {
            response = booking.get('status') === 'pending';
        }
        else if (this.statusButton.pending && !this.statusButton.accepted && this.statusButton.completed) {
            ...
            response = booking.get('status') === 'completed' || booking.get('status') === 'pending';
        }
        else if (this.statusButton.pending && !this.statusButton.accepted && !this.statusButton.completed) {
            response = booking.get('status') === 'completed' || booking.get('status') === 'accepted';
        }
        else if (!this.statusButton.pending && !this.statusButton.accepted && this.statusButton.completed) {
            response = booking.get('status') === 'pending' || booking.get('status') === 'accepted';
        }
        else if (this.statusButton.pending && this.statusButton.accepted && this.statusButton.completed) {
            response = false;
        }
        else {
            response = booking.get('status') === 'pending' || booking.get('status') === 'accepted' || booking.get('status') === 'completed';
        }
        return response;
    };
    AppointmentsPage.prototype.completeBooking = function (booking) {
        var _this = this;
        if (this.userRole === 'Artist' && booking.attributes.status !== 'completed') {
            var alert_1 = this.alertCtrl.create({
                title: 'Booking',
    ...
    AppointmentsPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'page-appointments',template:/*ion-inline-start:"/Users/rapsong11/Desktop/Groove+web(2018-6-24)/DistrictGroove/src/pages/appointments/appointments.html"*/'<!--\n  Generated template for the AppointmentsPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n  <ion-navbar>\n    <button ion-button menuToggle>\n      <ion-icon name="menu"></ion-icon>\n    </button>\n    <ion-title>Appointments</ion-title>\n    <ion-buttons end>\n        <button ion-button icon-only (click)="openChat()">\n          <ion-icon ios="ios-chatbubbles" md="ios-chatbubbles"></ion-icon>\n        </button>\n      </ion-buttons>\n  </ion-navbar>\n</ion-header>\n\n<ion-content>\n  <div class="button-bar" *ngIf="!isLoading" style="display: flex;padding-bottom : 1px;" >\n    <a class="button button-assertive" (click)="changeStatusView(\'pending\')" style="border-radius: 0px !important; padding: 16px; flex: 1; border: 1px solid;" [ngClass]="statusButton.pending">Pending</a>\n    <a class="button button-calm" (click)="changeStatusView(\'accepted\')" style="border-radius: 0px !important; padding: 16px; flex: 1; border: 1px solid;" [ngClass]="statusButton.accepted">Accepted</a>\n    <a class="button button-balanced" (click)="changeStatusView(\'completed\')" style="border-radius: 0px !important; padding: 16px; flex: 1; border: 1px solid;" [ngClass]="statusButton.completed">Completed</a>\n  </div>\n  <div *ngIf="statusButton.pending && statusButton.accepted && statusButton.completed"> <p style="padding-left: 15px; padding-right: 15px; text-align: center; padding-top: 50%;">You filtered out Pending, Accepted, and Completed Appointments. This will display an empty list.</p></div>\n  <ion-list>\n    <ion-item *ngFor="let booking of bookings">\n      <ion-avatar item-start>\n        <img [src]="booking.attributes.artistInfo.avatar || profilePicTemp" item-left>\n      </ion-avatar>\n      <h2>{{booking.attributes.artistInfo.firstName}} {{booking.attributes.artistInfo.lastName}}</h2>\n      <p>{{booking.attributes.schedule | date: "MMMM dd yyyy"}} - {{booking.attributes.schedule | date: "h:mm a"}}</p>\n      <p>Total : $ {{booking.attributes.totalBill}}</p>\n      <p>Status : \n        <span *ngIf="booking.attributes.status === \'completed\'"><b style="color: #33cd5f;">Completed</b></span>\n        <span *ngIf="booking.attributes.status === \'pending\'"><b style="color: #f1807a;">Pending</b></span>\n        <span *ngIf="booking.attributes.status === \'accepted\'"><b style="color: #11c1f3;">Accepted</b></span>\n      </p>\n      <button style="height: 25px;" *ngIf=" booking.attributes.isCompleted && ! booking.attributes.isReviewed && userRole === \'Customer\'" class="button button-small button-block button-energized" (click)="openReviewModal(booking)">Create Review</button>\n      <button style="height: 25px;" *ngIf=" booking.attributes.status !== \'completed\' &&  userRole === \'Artist\' && booking.attributes.status === \'accepted\'" class="button button-small button-block button-energized" (click)="completeBooking(booking)">Complete Booking</button>\n      <button style="height: 25px;" *ngIf=" booking.attributes.status !== \'completed\' &&  userRole === \'Artist\' && booking.attributes.status === \'pending\'" class="button button-small button-block button-energized" (click)="acceptBooking(booking)">Accept Booking</button>\n    </ion-item>\n  </ion-list>\n</ion-content>\n'/*ion-inline-end:"/Users/rapsong11/Desktop/Groove+web(2018-6-24)/DistrictGroove/src/pages/appointments/appointments.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["m" /* NavParams */], __WEBPACK_IMPORTED_MODULE_2__providers_book_book__["a" /* BookProvider */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["b" /* AlertController */]])
    ], AppointmentsPage);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_book_book__ = __webpack_require__(106);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var ReviewPage = /** @class */ (function () {
    ...
    ReviewPage.prototype.submitReview = function () {
        var _this = this;
        if (this.rating.title == '' || this.rating.review == '' || this.rating.rate == 0) {
            var alert_1 = this.alertCtrl.create({
                title: 'Warning!',
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__providers_artist_artist__ = __webpack_require__(86);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var PerformerAccountPage = /** @class */ (function () {
    ...
    PerformerAccountPage.prototype.changePassword = function () {
        var changePasswordPage = this.modalController.create(__WEBPACK_IMPORTED_MODULE_5__change_password_change_password__["a" /* ChangePasswordPage */]);
        changePasswordPage.present();
    };
    ...
    PerformerAccountPage.prototype.addService = function () {
        var _this = this;
        if (this.customerProfile.id === '' || this.description === '' || this.serviceName === '' || this.price === '' || this.duration == '') {
            return;
        }
        if (parseInt(this.duration) <= 0 || parseInt(this.price) <= 0) {
            return;
        }
        this.artistProvider.addService(this.customerProfile.id, this.serviceName, this.description, this.price, this.duration)
    ...
    PerformerAccountPage.prototype.updatePriceRange = function () {
        ...
        this.customerProfile.set("priceRange", { low: this.findMin(this.priceRange), high: this.findMax(this.priceRange) });
        return this.userPrivider.updateProfile(this.customerProfile).then(function (result) {
            console.log(result);
        });
    };
                    ...
                    handler: function () {
                        _this.serviceList.forEach(function (item) {
                            if (item.id === service.id) {
                                _this.artistProvider.removeService(item)
                                    .then(function (result) {
                                    var alert = _this.alertCtrl.create({
                                        title: 'Service',
            ...
            buttons: [
                {
                    ...
                    icon: 'camera',
                    handler: function () {
                        _this.camera.getPicture(_this.cameraOption).then(function (imagePath) {
                            return imagePath;
                        }).then(function (imageBlob) {
                    ...
                    icon: 'images',
                    handler: function () {
                        _this.camera.getPicture(_this.galleryOption).then(function (imagePath) {
                            return imagePath;
                        }).then(function (imageBlob) {
                            return _this.uploadImage(imageBlob);
                        });
    ...
    PerformerAccountPage.prototype.addPortfolio = function (url, description, type, account) {
        ...
        this.artistProvider.addPortfolio(url, description, type, account)
            .then(function (result) {
            var alert = _this.alertCtrl.create({
                title: 'Portfolio',
    ...
    PerformerAccountPage.prototype.removePortfolio = function (portfolio) {
        ...
        var alert = this.alertCtrl.create({
            ...
            buttons: [{
                    ...
                    text: 'Yes, I am sure!',
                    handler: function () {
                        _this.artistProvider.removePortfolio(portfolio)
                            .then(function (result) {
                            var alert = _this.alertCtrl.create({
                                title: 'Portfolio',
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__filter_filter__ = __webpack_require__(116);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__sort_sort__ = __webpack_require__(117);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__ionic_native_geolocation__ = __webpack_require__(105);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_parse__ = __webpack_require__(35);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_parse___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_5_parse__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__providers_artist_artist__ = __webpack_require__(86);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__artist_artist__ = __webpack_require__(118);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__agm_core__ = __webpack_require__(107);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__inbox_inbox__ = __webpack_require__(60);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var HomePage = /** @class */ (function () {
    function HomePage(navCtrl, navParams, geoLocation, artistProvider, events, alertCtrl, mapsAPILoader, ngZone) {
        var _this = this;
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.geoLocation = geoLocation;
    ...
    HomePage.prototype.ionViewDidLoad = function () {
        ...
        this.mapsAPILoader.load().then(function () {
            var nativeHomeInputBox = document.getElementById('addressInput').getElementsByTagName('input')[0];
            ...
            autocomplete.addListener("place_changed", function () {
                _this.ngZone.run(function () {
                    ...
                    var point = new __WEBPACK_IMPORTED_MODULE_5_parse__["Parse"].GeoPoint({ latitude: latitude, longitude: longitude });
        ...
        this.geoLocation.getCurrentPosition().then(function (resp) {
            _this.coordinate = resp.coords;
            var point = new __WEBPACK_IMPORTED_MODULE_5_parse__["Parse"].GeoPoint({ latitude: _this.coordinate.latitude, longitude: _this.coordinate.longitude });
    ...
    HomePage.prototype.sortAndFilter = function (artists) {
        ...
        var point = new __WEBPACK_IMPORTED_MODULE_5_parse__["Parse"].GeoPoint({ latitude: this.coordinate.latitude, longitude: this.coordinate.longitude });
        var tempArtist = artists.filter(function (artist) {
            var difference = Math.sqrt((point._latitude - artist.attributes.coordinates._latitude) * (point._latitude - artist.attributes.coordinates._latitude) + (point._longitude - artist.attributes.coordinates._longitude) * (point._longitude - artist.attributes.coordinates._longitude));
            return (difference < _this.distance) && ((artist.attributes.serviceType === 'DJ' && _this.filter.Dj) || (artist.attributes.serviceType === 'Artist' && _this.filter.Artist) || (artist.attributes.serviceType === 'Band' && _this.filter.Band));
        });
        ...
        this.artists = tempArtist.sort(function (artist1, artist2) {
            switch (this_.filter.sort) {
                case 'Distance':
                    ...
                    var difference1 = Math.sqrt((point._latitude - coord1._latitude) * (point._latitude - coord1._latitude) + (point._longitude - coord1._longitude) * (point._longitude - coord1._longitude));
                    var difference2 = Math.sqrt((point._latitude - coord2._latitude) * (point._latitude - coord2._latitude) + (point._longitude - coord2._longitude) * (point._longitude - coord2._longitude));
    ...
    HomePage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'page-home',template:/*ion-inline-start:"/Users/rapsong11/Desktop/Groove+web(2018-6-24)/DistrictGroove/src/pages/home/home.html"*/'<ion-header>\n  <ion-navbar>\n    <button ion-button menuToggle>\n      <ion-icon name="menu"></ion-icon>\n    </button>\n    <ion-buttons end>\n        <button ion-button icon-only (click)="openChat()">\n          <ion-icon ios="ios-chatbubbles" md="ios-chatbubbles"></ion-icon>\n        </button>\n      </ion-buttons>\n\n  </ion-navbar>\n</ion-header>\n\n<ion-content overflow-scroll="true">\n  <div style="padding: 10px; background: black">\n    <ion-input [(ngModel)]="address" id="addressInput" class="white-input" placeholder="Find Artist By Entering Location..." type="text"></ion-input>\n  </div>\n  <div class="row" style="padding: 15px;">\n    <div class="col">\n      <ion-label class="non-button" icon-left (click)="showFilters(true, \'Filters\')" style="height: 30px !important;">\n        <ion-icon name="funnel"></ion-icon>\n        Filter\n      </ion-label>\n    </div>\n\n    <div class="col" style="text-align: center;">\n      <ion-label class="non-button" icon-left (click)="showFilters(false, \'Sort By\')" style="height: 30px !important;">\n        <ion-icon name="swap"></ion-icon>\n        Sort\n      </ion-label>\n    </div>\n\n    <div class="col" style="text-align: right;">\n      <ion-label class="non-button" icon-left (click)="findArtistsNearby()" style="height: 30px !important;">\n        <ion-icon ios="ios-locate" md="md-locate"></ion-icon>\n      </ion-label>\n      \n    </div>\n  </div>\n\n\n  <ion-list>\n    <ion-card class="measure f1 center bg-white br3 pa3 pa4-ns mv3 ba b--black-10" *ngFor="let artist of artists" (click)="itemTapped($event, artist)">\n      <img class="mw5 center  br-100" [src]="artist.attributes.avatar || profilePicTemp">\n      <div class="mt4 tc">{{artist.attributes.stageName}}</div>\n\n    </ion-card>\n</ion-list>\n\n\n  <!-- <ion-list>\n    <ion-item *ngFor="let artist of artists" (click)="itemTapped($event, artist)">\n      <ion-avatar item-start>\n        <img [src]="artist.attributes.avatar || profilePicTemp">\n      </ion-avatar>\n      <h2 *ngIf="!artist.attributes.stageName">{{artist.attributes.firstName}} {{artist.attributes.lastName}}</h2>\n      <h2 *ngIf="artist.attributes.stageName">{{artist.attributes.stageName}}</h2>\n    </ion-item>\n  </ion-list> -->\n</ion-content>\n'/*ion-inline-end:"/Users/rapsong11/Desktop/Groove+web(2018-6-24)/DistrictGroove/src/pages/home/home.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["m" /* NavParams */], __WEBPACK_IMPORTED_MODULE_4__ionic_native_geolocation__["a" /* Geolocation */], __WEBPACK_IMPORTED_MODULE_6__providers_artist_artist__["a" /* ArtistProvider */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["d" /* Events */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["b" /* AlertController */], __WEBPACK_IMPORTED_MODULE_8__agm_core__["b" /* MapsAPILoader */], __WEBPACK_IMPORTED_MODULE_0__angular_core__["N" /* NgZone */]])
    ], HomePage);
    return HomePage;
}());
...
var ImagePage = /** @class */ (function () {
    ...
    ImagePage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'page-image',template:/*ion-inline-start:"/Users/rapsong11/Desktop/Groove+web(2018-6-24)/DistrictGroove/src/pages/image/image.html"*/'<!--\n  Generated template for the ImagePage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n\n  <ion-navbar>\n    <ion-title>{{portfolio.attributes.artistInfo.name}}</ion-title>\n  </ion-navbar>\n\n</ion-header>\n\n\n<ion-content padding>\n\n</ion-content>\n'/*ion-inline-end:"/Users/rapsong11/Desktop/Groove+web(2018-6-24)/DistrictGroove/src/pages/image/image.html"*/,
        }),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__ionic_native_themeable_browser__ = __webpack_require__(182);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var SoundCloudPage = /** @class */ (function () {
    ...
    SoundCloudPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'page-sound-cloud',template:/*ion-inline-start:"/Users/rapsong11/Desktop/Groove+web(2018-6-24)/DistrictGroove/src/pages/sound-cloud/sound-cloud.html"*/'<!--\n  Generated template for the SoundCloudPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n\n  <ion-navbar>\n    <ion-title>{{portfolio.attributes.artistInfo.name}}</ion-title>\n  </ion-navbar>\n\n</ion-header>\n\n<ion-content>\n\n</ion-content>\n'/*ion-inline-end:"/Users/rapsong11/Desktop/Groove+web(2018-6-24)/DistrictGroove/src/pages/sound-cloud/sound-cloud.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["m" /* NavParams */], __WEBPACK_IMPORTED_MODULE_2__ionic_native_themeable_browser__["a" /* ThemeableBrowser */]])
    ], SoundCloudPage);
...
var YoutubePage = /** @class */ (function () {
    ...
    YoutubePage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'page-youtube',template:/*ion-inline-start:"/Users/rapsong11/Desktop/Groove+web(2018-6-24)/DistrictGroove/src/pages/youtube/youtube.html"*/'<!--\n  Generated template for the YoutubePage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n\n  <ion-navbar>\n    <ion-title>{{portfolio.attributes.artistInfo.name}}</ion-title>\n  </ion-navbar>\n\n</ion-header>\n\n\n<ion-content>\n\n</ion-content>\n'/*ion-inline-end:"/Users/rapsong11/Desktop/Groove+web(2018-6-24)/DistrictGroove/src/pages/youtube/youtube.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["m" /* NavParams */]])
    ], YoutubePage);
    return YoutubePage;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__ionic_native_splash_screen__ = __webpack_require__(340);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__pages_login_login__ = __webpack_require__(119);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__pages_register_register__ = __webpack_require__(87);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__providers_user_user__ = __webpack_require__(20);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__angular_http__ = __webpack_require__(505);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__angular_common_http__ = __webpack_require__(44);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__pages_account_account__ = __webpack_require__(204);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__pages_inbox_inbox__ = __webpack_require__(60);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__pages_appointments_appointments__ = __webpack_require__(207);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__providers_system_system__ = __webpack_require__(506);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__providers_chat_chat__ = __webpack_require__(104);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18__pages_chat_chat__ = __webpack_require__(115);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19__providers_message_message__ = __webpack_require__(291);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_20__components_message_box_message_box__ = __webpack_require__(507);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_21__pages_sort_sort__ = __webpack_require__(117);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_22__pages_filter_filter__ = __webpack_require__(116);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_23__ionic_native_geolocation__ = __webpack_require__(105);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_24__providers_artist_artist__ = __webpack_require__(86);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_25__pages_artist_artist__ = __webpack_require__(118);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_26__pages_book_book__ = __webpack_require__(205);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_27__providers_book_book__ = __webpack_require__(106);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_28__ionic_native_camera__ = __webpack_require__(147);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_29__ionic_native_file__ = __webpack_require__(508);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_30__pages_review_review__ = __webpack_require__(208);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_31__pages_change_password_change_password__ = __webpack_require__(114);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_32_ionic2_rating__ = __webpack_require__(509);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_33__agm_core__ = __webpack_require__(107);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_34__pages_performer_register_performer_register__ = __webpack_require__(206);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_35__pages_performer_account_performer_account__ = __webpack_require__(209);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_36__providers_sound_cloud_sound_cloud__ = __webpack_require__(511);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_37__pages_youtube_youtube__ = __webpack_require__(345);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_38__pages_sound_cloud_sound_cloud__ = __webpack_require__(344);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_39__pages_image_image__ = __webpack_require__(343);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_40__ionic_native_themeable_browser__ = __webpack_require__(182);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["J" /* NgModule */])({
            ...
            declarations: [
                ...
                __WEBPACK_IMPORTED_MODULE_15__pages_appointments_appointments__["a" /* AppointmentsPage */],
                __WEBPACK_IMPORTED_MODULE_18__pages_chat_chat__["a" /* ChatPage */],
                __WEBPACK_IMPORTED_MODULE_20__components_message_box_message_box__["a" /* MessageBoxComponent */],
                __WEBPACK_IMPORTED_MODULE_21__pages_sort_sort__["a" /* SortPage */],
                __WEBPACK_IMPORTED_MODULE_22__pages_filter_filter__["a" /* FilterPage */],
                __WEBPACK_IMPORTED_MODULE_25__pages_artist_artist__["a" /* ArtistPage */],
                __WEBPACK_IMPORTED_MODULE_26__pages_book_book__["a" /* BookPage */],
                __WEBPACK_IMPORTED_MODULE_30__pages_review_review__["a" /* ReviewPage */],
                __WEBPACK_IMPORTED_MODULE_31__pages_change_password_change_password__["a" /* ChangePasswordPage */],
                __WEBPACK_IMPORTED_MODULE_34__pages_performer_register_performer_register__["a" /* PerformerRegisterPage */],
                __WEBPACK_IMPORTED_MODULE_35__pages_performer_account_performer_account__["a" /* PerformerAccountPage */],
                __WEBPACK_IMPORTED_MODULE_37__pages_youtube_youtube__["a" /* YoutubePage */],
                __WEBPACK_IMPORTED_MODULE_38__pages_sound_cloud_sound_cloud__["a" /* SoundCloudPage */],
                __WEBPACK_IMPORTED_MODULE_39__pages_image_image__["a" /* ImagePage */]
            ],
            imports: [
                ...
                __WEBPACK_IMPORTED_MODULE_33__agm_core__["a" /* AgmCoreModule */].forRoot({
            ...
            providers: [
                ...
                __WEBPACK_IMPORTED_MODULE_16__providers_system_system__["a" /* SystemProvider */],
                ...
                __WEBPACK_IMPORTED_MODULE_19__providers_message_message__["a" /* MessageProvider */],
                __WEBPACK_IMPORTED_MODULE_24__providers_artist_artist__["a" /* ArtistProvider */],
                __WEBPACK_IMPORTED_MODULE_27__providers_book_book__["a" /* BookProvider */],
                __WEBPACK_IMPORTED_MODULE_28__ionic_native_camera__["a" /* Camera */],
                __WEBPACK_IMPORTED_MODULE_29__ionic_native_file__["a" /* File */],
                __WEBPACK_IMPORTED_MODULE_36__providers_sound_cloud_sound_cloud__["a" /* SoundCloudProvider */],
                __WEBPACK_IMPORTED_MODULE_40__ionic_native_themeable_browser__["a" /* ThemeableBrowser */]
            ]
        })
    ], AppModule);
    return AppModule;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__pages_register_register__ = __webpack_require__(87);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_parse__ = __webpack_require__(35);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_parse___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_8_parse__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__providers_user_user__ = __webpack_require__(20);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__pages_account_account__ = __webpack_require__(204);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__pages_appointments_appointments__ = __webpack_require__(207);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__pages_performer_account_performer_account__ = __webpack_require__(209);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var MyApp = /** @class */ (function () {
    function MyApp(platform, statusBar, splashScreen, menuToggle, events, userService) {
        ...
        this.pages = [
            ...
            { title: 'Find Artists', component: __WEBPACK_IMPORTED_MODULE_5__pages_list_list__["a" /* ListPage */], icon: "ios-pin-outline" }
        ];
        this.loggedInPages = [
            { title: 'Home', component: __WEBPACK_IMPORTED_MODULE_4__pages_home_home__["a" /* HomePage */], icon: "ios-home-outline" },
            { title: 'Appointments', component: __WEBPACK_IMPORTED_MODULE_11__pages_appointments_appointments__["a" /* AppointmentsPage */], icon: "ios-book-outline" }
        ];
    }
    MyApp.prototype.initializeApp = function () {
        ...
        __WEBPACK_IMPORTED_MODULE_8_parse__["Parse"].initialize("myAppId", "myJavascriptKey");
        //    Parse.serverURL = 'https://districtgroove-api.herokuapp.com/parse';
        __WEBPACK_IMPORTED_MODULE_8_parse__["Parse"].serverURL = 'https://districtgrooveapi.herokuapp.com/parse';
    };
    ...
    MyApp.prototype.viewProfile = function () {
        if (this.hasLoggedIn) {
            ...
            if (this.currentUser.className === 'Customer') {
                this.nav.push(__WEBPACK_IMPORTED_MODULE_10__pages_account_account__["a" /* AccountPage */], {
                    account: this.currentUser
                });
            }
            else if (this.currentUser.className === 'Artist') {
                this.nav.push(__WEBPACK_IMPORTED_MODULE_12__pages_performer_account_performer_account__["a" /* PerformerAccountPage */], {
                    account: this.currentUser
                });
            }
        }
...
var MessageBoxComponent = /** @class */ (function () {
    ...
    MessageBoxComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'message-box',template:/*ion-inline-start:"/Users/rapsong11/Desktop/Groove+web(2018-6-24)/DistrictGroove/src/components/message-box/message-box.html"*/'<div class="chatBubble" style="width: 100%">\n  <div style="text-align: center">\n    <span style="color:gray;font-size:13px">{{ message.createdAt | date: \'MMM dd, HH:mm\'}}</span> \n  </div>\n  <div>\n    <img class="chat-img {{isFromSender}}" style="padding: 2px;border-radius: 50%;width: 40px;" src="{{photo || profilePicTemp}}">\n    <div class="chat-bubble {{isFromSender}}">\n      <div class="message" >\n        {{message.message}} \n      </div> \n    </div>\n  </div>\n</div>\n'/*ion-inline-end:"/Users/rapsong11/Desktop/Groove+web(2018-6-24)/DistrictGroove/src/components/message-box/message-box.html"*/
        }),
...
var ListPage = /** @class */ (function () {
    function ListPage(navCtrl, navParams, geoLocation, artistProvider, events, alertCtrl, mapsAPILoader, ngZone) {
        var _this = this;
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.geoLocation = geoLocation;
    ...
    ListPage.prototype.moreDataCanBeLoaded = function () {
        return true;
    };
    ListPage.prototype.findArtistsNearby = function () {
        var _this = this;
        var alert = this.alertCtrl.create({
            title: 'Find Artists',
            message: 'Find artists near to your current location?',
    ...
    ListPage.prototype.getAddress = function (point) {
        var _this = this;
        var geocoder = new google.maps.Geocoder;
        var latlng = { lat: point.latitude, lng: point.longitude };
        geocoder.geocode({ 'location': latlng }, function (results, status) {
    ...
    ListPage.prototype.getArtist = function (point) {
        var _this = this;
        this.artistProvider.getArtist(point).then(function (results) {
            if (results == null || results == undefined || results.length == 0) {
                return;
    ...
    ListPage.prototype.getAngleFromMile = function (mile) {
        return (1 * mile) / 60;
    };
    ListPage.prototype.showFilters = function (bMode, mode) {
        if (bMode) {
            this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_2__filter_filter__["a" /* FilterPage */], {
                mode: mode,
                filter: this.filter
    ...
    ListPage.prototype.sortAndFilter = function (artists) {
        var _this = this;
        if (artists === undefined || this.coordinate === undefined) {
            return;
        }
    ...
    ListPage.prototype.nameCompare = function (artist1, artist2) {
        var stageName1, stageName2;
        if (artist1.attributes.stageName !== undefined) {
            stageName1 = artist1.attributes.stageName;
        }
    ...
    ListPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'page-list',template:/*ion-inline-start:"/Users/rapsong11/Desktop/Groove+web(2018-6-24)/DistrictGroove/src/pages/list/list.html"*/'<ion-header>\n  <ion-navbar>\n    <button ion-button menuToggle>\n      <ion-icon name="menu"></ion-icon>\n    </button>\n    <ion-title>Find Artists</ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content overflow-scroll="true">\n  <div style="padding: 10px; background: black">\n    <ion-input [(ngModel)]="address" id="addressInput" class="white-input" placeholder="Find Artist By Entering Location..." type="text"></ion-input>\n  </div>\n  <div class="row" style="padding: 15px;">\n    <div class="col">\n      <ion-label class="non-button" icon-left (click)="showFilters(true, \'Filters\')" style="height: 30px !important;">\n        <ion-icon name="funnel"></ion-icon>\n        Filter\n      </ion-label>\n    </div>\n\n    <div class="col" style="text-align: center;">\n      <ion-label class="non-button" icon-left (click)="showFilters(false, \'Sort By\')" style="height: 30px !important;">\n        <ion-icon name="swap"></ion-icon>\n        Sort\n      </ion-label>\n    </div>\n\n    <div class="col" style="text-align: right;">\n      <ion-label class="non-button" icon-left (click)="findArtistsNearby()" style="height: 30px !important;">\n        <ion-icon ios="ios-locate" md="md-locate"></ion-icon>\n      </ion-label>\n      \n    </div>\n  </div>\n  <ion-list>\n    <ion-item *ngFor="let artist of artists" (click)="itemTapped($event, artist)">\n      <ion-avatar item-start>\n        <img [src]="artist.attributes.avatar || profilePicTemp">\n      </ion-avatar>\n      <h2 *ngIf="!artist.attributes.stageName">{{artist.attributes.firstName}} {{artist.attributes.lastName}}</h2>\n      <h2 *ngIf="artist.attributes.stageName">{{artist.attributes.stageName}}</h2>\n    </ion-item>\n  </ion-list>\n</ion-content>\n'/*ion-inline-end:"/Users/rapsong11/Desktop/Groove+web(2018-6-24)/DistrictGroove/src/pages/list/list.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["m" /* NavParams */], __WEBPACK_IMPORTED_MODULE_4__ionic_native_geolocation__["a" /* Geolocation */], __WEBPACK_IMPORTED_MODULE_6__providers_artist_artist__["a" /* ArtistProvider */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["d" /* Events */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["b" /* AlertController */], __WEBPACK_IMPORTED_MODULE_8__agm_core__["b" /* MapsAPILoader */], __WEBPACK_IMPORTED_MODULE_0__angular_core__["N" /* NgZone */]])
    ], ListPage);
    return ListPage;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_chat_chat__ = __webpack_require__(104);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__chat_chat__ = __webpack_require__(115);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__list_list__ = __webpack_require__(52);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__providers_user_user__ = __webpack_require__(20);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
...
var InboxPage = /** @class */ (function () {
    ...
    InboxPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'page-inbox',template:/*ion-inline-start:"/Users/rapsong11/Desktop/Groove+web(2018-6-24)/DistrictGroove/src/pages/inbox/inbox.html"*/'<!--\n  Generated template for the InboxPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n    <ion-navbar>\n      <button ion-button menuToggle>\n        <ion-icon name="menu"></ion-icon>\n      </button>\n      <ion-title>Inbox</ion-title>\n\n    </ion-navbar>\n  </ion-header>\n\n<ion-content padding>\n  <ion-list>\n    <ion-item *ngFor="let chat of chats" (click)="itemTapped($event, chat)">\n      <ion-avatar item-start>\n        <img src="{{chat.attributes.artistInfo.avatar || profilePicTemp}}" item-left>\n      </ion-avatar>\n      <h2>{{chat.attributes.artistInfo.firstName}} {{chat.attributes.artistInfo.lastName}}</h2>\n      <p>{{chat.attributes.lastMessage}}</p>\n      <span style="color:gray;font-size:13px">{{ chat.attributes.createdAt | date: \'MMM dd, HH:mm\'}}</span> \n    </ion-item>\n  </ion-list>\n</ion-content>\n'/*ion-inline-end:"/Users/rapsong11/Desktop/Groove+web(2018-6-24)/DistrictGroove/src/pages/inbox/inbox.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["m" /* NavParams */], __WEBPACK_IMPORTED_MODULE_2__providers_chat_chat__["a" /* ChatProvider */], __WEBPACK_IMPORTED_MODULE_5__providers_user_user__["a" /* UserProvider */]])
    ], InboxPage);
    return InboxPage;
}());
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_user_user__ = __webpack_require__(20);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__performer_register_performer_register__ = __webpack_require__(206);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var RegisterPage = /** @class */ (function () {
    ...
    RegisterPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'page-register',template:/*ion-inline-start:"/Users/rapsong11/Desktop/Groove+web(2018-6-24)/DistrictGroove/src/pages/register/register.html"*/'<!--\n  Generated template for the RegisterPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n\n  <ion-navbar>\n    <ion-title>Register</ion-title>\n  </ion-navbar>\n\n</ion-header>\n\n<ion-content padding style="background-color: black">\n  <div style="text-align: center;">\n    <h1 style="color: rgb(255, 255, 255); font-size: 30px;">Create your <b>DistrictGroove Account</b> for <b>FREE.</b></h1>\n    <h1 style="color: rgb(255, 255, 255); font-size: 16px;">No credit card required.</h1>\n  </div>\n  <button ion-button class="round-white-back" (click)="openPerformerRegisterPage()">I\'m A Preformer</button>\n  <ion-input class="round-white-back" placeholder="First Name" type="text" style="height: 40px !important;" [(ngModel)]="register.firstName" required></ion-input>\n  <ion-input class="round-white-back" placeholder="Last Name" type="text" style="height: 40px !important;" [(ngModel)]="register.lastName" required></ion-input>\n  <ion-input class="round-white-back" placeholder="Email" type="email" style="height: 40px !important;" [(ngModel)]="register.email" required></ion-input>\n  <ion-input class="round-white-back" placeholder="Mobile Number" type="number" style="height: 40px !important;" [(ngModel)]="register.contactNumber" required></ion-input>\n  <ion-input class="round-white-back" placeholder="Password" type="password" style="height: 40px !important;" [(ngModel)]="register.password" required></ion-input>\n  <ion-input class="round-white-back" placeholder="Confirm Password" type="password" style="height: 40px !important;" [(ngModel)]="register.confirmPassword" required></ion-input>\n  <div>\n    <a href="#" onclick="window.open(\'\', \'_system\', \'location=yes\'); return false;" style="font-size:12px;">By creating an account, I agree to DistrictGroove\'s <b>Terms of Service</b> and <b>Privacy Policy</b></a>\n  </div>\n  <button ion-button class="round-white-back" (click)="doRegister()">Register Now!</button>\n\n</ion-content>\n'/*ion-inline-end:"/Users/rapsong11/Desktop/Groove+web(2018-6-24)/DistrictGroove/src/pages/register/register.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["m" /* NavParams */], __WEBPACK_IMPORTED_MODULE_2__providers_user_user__["a" /* UserProvider */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["d" /* Events */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["b" /* AlertController */]])
    ], RegisterPage);
    return RegisterPage;
